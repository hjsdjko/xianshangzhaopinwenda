...
//            return R.error(511,"永远不会进入");
    ...
    */
    ...
    public R shenhe(@RequestBody ToudiEntity toudi, HttpServletRequest request){
        logger.debug("shenhe方法:,,Controller:{},,toudi:{}",this.getClass().getName(),toudi.toString());

//        if(toudi.getToudiYesnoTypes() == 2){//通过
//            toudi.setToudiTypes();
//        }else if(toudi.getToudiYesnoTypes() == 3){//拒绝
//            toudi.setToudiTypes();
//        }
        toudiService.updateById(toudi);//审核
        return R.ok();
    }
...
//                            toudiEntity.setZhaopinFile(data.get(0));                    //申请表 要改的
